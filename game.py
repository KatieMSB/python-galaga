...
class Game(object):
    ...
    def _get_reward(self):
        ...
        enemy_points = math.floor(pow(500, 0.05 * enemies_killed)) + 19
        ...
        print(f"Shots Fired: {shots_fired} Rockets Avoided: {rockets_avoided} Enemies: {enemy_points} Time: {time_points} Near Miss: {-1 * near_miss_points} Waves: {wave_count * 100}")
